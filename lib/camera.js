function Camera(tileSize, initialScrollX, initialScrollY, screenWidth, screenHeight, mapSize) {
  ...
  this.canMoveDown = function() {
    if(this.scrollY + this.screenHeight + this.movementSize < (this.mapSize * this.tileSize)) {
      return true;
    } else {
      return false;
    }
  ...
  this.canMoveRight = function() {
    if(this.scrollX + this.screenWidth + this.movementSize < (this.mapSize * this.tileSize)) {
      return true;
    } else {
      return false;
    }
